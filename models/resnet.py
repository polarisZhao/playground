...
def ResNet18():
    return ResNet(PreResidualBlock, [2, 2, 2, 2])
...
def PreResNet34():
    return ResNet(PreResidualBlock, [3, 4, 6, 3])

def PreResNet50():
    return ResNet(PreBottleneck, [3, 4, 6, 3])

def PreResNet101():
    return ResNet(PreBottleneck, [3, 4, 23, 3])

def PreResNet152():
    return ResNet(PreBottleneck, [3, 8, 36, 3])
