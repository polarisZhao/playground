...
def show_generator_output(samples, images_grid, image_mode, steps):
    """Show example output for the generator
        samples: samples Images to display
        images_grid : grid to dispay Images
        image_mode: The mode to use for images ("RGB" or "L")
    """
    cmap = None if image_mode == 'RGB' else 'gray'
#    images_grid = helper.images_square_grid(samples, image_mode)
    pyplot.imshow(images_grid, cmap=cmap)
    pyplot.savefig('./img/face_step_' + str(steps) + '.jpg')
...
#def show_generator_output(sess, n_images, input_z, out_channel_dim, image_mode, epoch_i, steps):
#    """
#    Show example output for the generator
...
#        param image_mode: The mode to use for images ("RGB" or "L")
    ...
    pyplot.imshow(images_grid, cmap=cmap)
    # pyplot.show()i
    pyplot.savefig("face_epoch_"+ epoch_i + "step_" + steps + ".jpg")
"""
